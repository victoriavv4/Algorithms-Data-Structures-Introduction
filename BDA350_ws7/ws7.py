...
class HashSet(object):
    ...
    def add(self, item):
        ...
        if not item in self:
            # creating the items' index value using self._index hash method and storing items using chain method
            newEntry = Node(item, self._table[self._index])
            # adding the item to the array based its index created by hash method above ^
